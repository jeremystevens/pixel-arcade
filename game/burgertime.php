                    ...
                    <div class="aspect-square bg-gray-800 rounded-lg mb-4 overflow-hidden">
                        ...
                        <?php else: ?>
                            <div class="w-full h-full flex items-center justify-center">
                                <div class="text-6xl text-orange-400">
                ...
                <?php if (empty($scores)): ?>
                    <div class="retro-box bg-dark-purple border-2 border-neon-purple p-6 rounded-lg">
                        ...
                        <div class="text-center py-12">
                            <i class="fas fa-hamburger text-6xl text-orange-400 mb-4"></i>
                            <p class="text-xl text-neon-blue">NO SCORES RECORDED</p>
                            <p class="text-sm text-gray-400 mt-2">Cook up some burgers and set the first record!</p>
                        </div>
                    </div>
                <?php else: ?>
                    <?php 
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof MIDIPlayer !== 'undefined') {
                const player = new MIDIPlayer('/assets/music/burgertime.mp3');
                player.init();
            }
        });
    </script>
