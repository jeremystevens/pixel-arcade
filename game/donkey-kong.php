            ...
            <div class="lg:col-span-1">
                    ...
                    <div class="aspect-square bg-gray-800 rounded-lg mb-4 overflow-hidden">
                        ...
                        <?php else: ?>
                            <div class="w-full h-full flex items-center justify-center">
                                <div class="text-6xl text-orange-600">
                                    <i class="fas fa-hammer animate-bounce"></i>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="retro-box bg-dark-purple border-2 border-neon-purple p-6 rounded-lg">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <?php for ($i = 1; $i <= 4; $i++): ?>
                            <?php if (file_exists(__DIR__ . "/../assets/images/{$gameSlug}/screenshot{$i}.jpg")): ?>
                                <img src="/assets/images/<?php echo htmlspecialchars($gameSlug); ?>/screenshot<?php echo $i; ?>.jpg" 
                ...
                <?php if (empty($scores)): ?>
                    <div class="retro-box bg-dark-purple border-2 border-neon-purple p-6 rounded-lg">
                        ...
                        <div class="text-center py-12">
                            <i class="fas fa-hammer text-6xl text-orange-600 mb-4 animate-bounce"></i>
                            <p class="text-xl text-neon-blue">NO SCORES RECORDED</p>
                            <p class="text-sm text-gray-400 mt-2">Jump those barrels and save Pauline!</p>
                        </div>
                    </div>
                <?php else: ?>
                    <?php 
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof MIDIPlayer !== 'undefined') {
                const player = new MIDIPlayer('/assets/music/donkeykong.mp3');
                player.init();
            }
        });
    </script>
